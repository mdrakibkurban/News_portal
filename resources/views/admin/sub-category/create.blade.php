            ...
            <form action="{{ route('admin.sub-categories.store')}}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control @error('name_en') is-invalid @enderror" value="{{ old('name_en')}}" name="name_en" id="name_en" placeholder="SubCategory Name_EN">
                          @error('name_en')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('name_bn') is-invalid @enderror" value="{{ old('name_bn') }}" name="name_bn" id="name_bn" placeholder="SubCategory Name_BN">
                            @error('name_bn')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
