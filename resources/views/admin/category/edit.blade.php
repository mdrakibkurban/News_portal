                ...
                <div class="card-body">
                  <div class="form-group row">
                    <label for="name_en" class="col-sm-3 col-form-label">Name English </label>
                        <div class="col-sm-9">
                              <input type="text" class="form-control @error('name_en') is-invalid @enderror" value="{{ $category->name_en }}" name="name_en" id="name_en">
                              @error('name_en')
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('name_bn') is-invalid @enderror" value="{{ $category->name_bn }}" name="name_bn" id="name_bn">
                            @error('name_bn')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
