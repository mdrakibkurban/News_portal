            ...
            <form action="{{ route('admin.photos.update',$photo->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title_en" id="title_en"  value="{{ $photo->title_en}}"  class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title_bn" id="title_bn" value="{{ $photo->title_bn}}" class="form-control" placeholder="Title Bangla">
                        @error('title_bn')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            <img width="100" src="{{ asset('storage/photo_images/'.$photo->photo) }}" alt="news" id="showPhoto">
                        </div>
                    </div>
