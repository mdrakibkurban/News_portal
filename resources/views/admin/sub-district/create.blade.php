    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title mt-2">Sub-District Create</h3>
              <div class="card-tools">
                  <a href="{{ route('admin.sub-districts.index')}}" class="btn btn-primary">Sub-District list</a>
              </div>
            </div>
            <form action="{{ route('admin.sub-districts.store')}}" method="post">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control @error('subdistrict_en') is-invalid @enderror" value="{{ old('subdistrict_en')}}" name="subdistrict_en" id="subdistrict_en" placeholder="SubDistrict Name English">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('subdistrict_bn') is-invalid @enderror" value="{{ old('subdistrict_bn') }}" name="subdistrict_bn" id="subdistrict_bn" placeholder="SubDistrict Name Bangla">
