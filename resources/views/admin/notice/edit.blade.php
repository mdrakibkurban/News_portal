    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title mt-2">Notice Edit</h3>
            ...
            <form action="{{ route('admin.notices.update',$notice->id)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-radio d-inline mr-2">
                                <input class="custom-control-input" type="radio" id="active" value="1" name="status" {{ $notice->status == 1 ? "checked" : " " }}>
                                <label for="active" class="custom-control-label">Active</label>
                                </div>
                                <div class="custom-control custom-radio d-inline">
                                <input class="custom-control-input" type="radio" id="inactive"  value="0" name="status" {{ $notice->status == 0 ? "checked" : " " }}>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-info float-right">Update Notice</button>
                </div>
            </form>
